...
public class BatchPayWSSoapBindingSkeleton implements com.laanto.it.paycenter.pay.bill99pay.service.BatchPay, org.apache.axis.wsdl.Skeleton {
    private com.laanto.it.paycenter.pay.bill99pay.service.BatchPay impl;
    ...
    */
    ...
    static {
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "input"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://complatible.dto.domain.seashell.bill99.com", "QueryRequestBean"), com.laanto.it.paycenter.pay.bill99pay.pojo.QueryRequestBean.class, false, false), 
        ...
        _params = new org.apache.axis.description.ParameterDesc [] {
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "input"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://sandbox.99bill.com/apipay/services/BatchPayWS", "ArrayOf_tns1_BankRequestBean"), com.laanto.it.paycenter.pay.bill99pay.pojo.BankRequestBean[].class, false, false), 
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "username"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false), 
            new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "ip"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://schemas.xmlsoap.org/soap/encoding/", "string"), java.lang.String.class, false, false), 
        };
    ...
    public BatchPayWSSoapBindingSkeleton() {
        this.impl = new com.laanto.it.paycenter.pay.bill99pay.service.BatchPayWSSoapBindingImpl();
    }

    public BatchPayWSSoapBindingSkeleton(com.laanto.it.paycenter.pay.bill99pay.service.BatchPay impl) {
        this.impl = impl;
    }
    ...
    {
        com.laanto.it.paycenter.pay.bill99pay.pojo.QueryResponseBean[] ret = impl.queryDeal(input, username, ip);
        return ret;
    }
    ...
    {
        com.laanto.it.paycenter.pay.bill99pay.pojo.BankResponseBean[] ret = impl.bankPay(input, username, ip);
        return ret;
    }
    ...
    {
        com.laanto.it.paycenter.pay.bill99pay.pojo.SimpleResponseBean[] ret = impl.simplePay(input, username, ip);
        return ret;
    }
    ...
    {
        com.laanto.it.paycenter.pay.bill99pay.pojo.PostResponseBean[] ret = impl.postPay(input, username, ip);
        return ret;
    }
