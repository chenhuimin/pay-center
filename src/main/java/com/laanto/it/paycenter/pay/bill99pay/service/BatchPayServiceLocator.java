...
public class BatchPayServiceLocator extends org.apache.axis.client.Service implements com.laanto.it.paycenter.pay.bill99pay.service.BatchPayService {
    ...
    public com.laanto.it.paycenter.pay.bill99pay.service.BatchPay getBatchPayWS() throws javax.xml.rpc.ServiceException {
    ...
    public com.laanto.it.paycenter.pay.bill99pay.service.BatchPay getBatchPayWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.laanto.it.paycenter.pay.bill99pay.service.BatchPayWSSoapBindingStub _stub = new com.laanto.it.paycenter.pay.bill99pay.service.BatchPayWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.laanto.it.paycenter.pay.bill99pay.service.BatchPay.class.isAssignableFrom(serviceEndpointInterface)) {
                com.laanto.it.paycenter.pay.bill99pay.service.BatchPayWSSoapBindingStub _stub = new com.laanto.it.paycenter.pay.bill99pay.service.BatchPayWSSoapBindingStub(new java.net.URL(BatchPayWS_address), this);
                _stub.setPortName(getBatchPayWSWSDDServiceName());
                return _stub;
            }
        }
